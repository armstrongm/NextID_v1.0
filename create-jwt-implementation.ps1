...
Write-Host "Creating JWT Implementation" -ForegroundColor Cyan
Write-Host "====================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "Creating Updated SecurityConfig.java..." -ForegroundColor Yellow
$securityConfig = @'
...
Write-Host ""
Write-Host "JWT Implementation Created!" -ForegroundColor Green